  ...
  return (
    <div className="section">
      <div className="container">
        <div className="home-website-detail">
          ...
          <p>
            ...
            the spiritual aspects of your pilgrimage.
          </p>
          <h3>Need a Hajj Package Near You?</h3>
          <p>
            Finding the nearest travel agency with experience in Hajj
            arrangements can be challenging. As a trusted travel agency near
            you, Hajjharamain has built a reputation as the go-to choice for
            Hajj packages in the UAE. Our Dubai office is ready to assist,
            ensuring you have a seamless experience from start to finish.
          </p>
          <h4>Special Offers: Last-Minute Hajj Deals</h4>
          Are you looking for last-minute Hajj deals? Hajjharamain understands
          the importance of flexibility, especially for pilgrims planning their
          journey on short notice. Our team works tirelessly to secure
          accommodations and travel arrangements to meet your needs.
          <h3>Get in Touch with Hajjharamain</h3>
          <p>
